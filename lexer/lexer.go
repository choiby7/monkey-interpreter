...
func (l *Lexer) readChar() {
	if l.readPosition >= len(l.input) {
		l.ch = 0 // set to ASCII code for 'NUL' character
	} else {
		l.ch = l.input[l.readPosition] // current char
	}
	l.position = l.readPosition // move current position to readPosition
	l.readPosition += 1
}
...
// Helper function to peek char. Not advancing position.
